...
| 大写      |         | 小写       |          | 读音     | 大写     |        | 小写       |          | 读音     |
| --------- | ------- | ---------- | -------- | -------- | -------- | ------ | ---------- | -------- | -------- |
| A         | \alpha  | $\alpha$   | \alpha   | 阿法     |          |        | $\xi$      | \xi      | 克西     |
|           |         | $\beta$    | \beta    |          |          |        |            |          | 欧麦克$  |
| $\Gamma$  | \Gamma  | $\gamma$   | \gamma   | 伽马     |          |        | $\pi$      | \pi​      | 派       |
| $\Delta$  | \Delta  | $\delta$   | \delta   |          |          |        | $\rho$     | \rho     | 肉       |
|           |         | $\epsilon$ | \epsilon | 艾普西龙 |          |        | $\sigma$   | \sigma   | 西格玛   |
|           |         | $\zeta$    | \zeta    | 捷塔     |          |        | $\tau$     | \tau     | 套       |
| E         |         | $\eta$     | \eta     | 依塔     |          |        | $\upsilon$ | \upsilon | 宇普西龙 |
